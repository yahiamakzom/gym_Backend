...
const { addSubscreptions, getSubscriptions, searchSubscreptions, editClub, getClubEarns , editSubscription, deleteSubscription ,BankData ,getClubBankAccount } = require("../controllers/club")
